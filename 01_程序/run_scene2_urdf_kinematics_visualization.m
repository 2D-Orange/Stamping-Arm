...
% The SolidWorks exporter places joint_5 about 2 cm below the modeled stamp
% reference. The simplified model uses H_stamp as the stamp-face offset, so
% the MATLAB import copy should use -H_stamp for the lateral joint offset.
